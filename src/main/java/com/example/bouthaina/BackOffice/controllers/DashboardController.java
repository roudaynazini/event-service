...
public class DashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        loadView("/com/example/bouthaina/AdminView/CategorieList.fxml");
    ...
    private void handleEvenementsAction() {
        loadView("/com/example/bouthaina/AdminView/EvenementList.fxml");
    }
    ...
    private void showStatisticsDialog() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/com/example/bouthaina/BackOffice/views/StatisticsDialog.fxml"));
            ...
            scene.getStylesheets().add(getClass().getResource("/com/example/bouthaina/css/admin.css").toExternalForm());
    ...
    private void showAlert(String title, String message, Alert.AlertType alertType) {
        ...
        dialogPane.getStylesheets()
                .add(getClass().getResource("/com/example/bouthaina/css/admin.css").toExternalForm());
