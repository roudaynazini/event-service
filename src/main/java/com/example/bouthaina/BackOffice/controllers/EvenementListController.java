...
public class EvenementListController implements Initializable {
    ...
    private void openEvenementForm(Evenement evenement) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/com/example/bouthaina/AdminView/EvenementForm.fxml"));
    ...
    private void showEventDetails(Evenement evenement) {
        ...
        dialog.getDialogPane().getStylesheets().add(
                getClass().getResource("/com/example/bouthaina/css/admin.css").toExternalForm());
    ...
    private void handleExportAction() {
        try {
            List<Evenement> evenements = evenementService.getAll();
            File htmlFile = com.example.bouthaina.util.PdfExportService.exportEventsToHtml(evenements, categoriesMap);
