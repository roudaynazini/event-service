...
public class MenuController {
    ...
    void handlePosts(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/org/example/event_project/service-post.fxml"));
    ...
    void handleCommentaires(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/org/example/event_project/service-commentaire.fxml"));
            Stage stage = new Stage();
    ...
    private void handleShowBadges(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/org/example/event_project/Badges.fxml"));
            Stage stage = new Stage();
    ...
    private void ouvrirCommentairesPosts(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/org/example/event_project/PostDetails.fxml"));
            Stage stage = new Stage();
   ...
   public void Statistique(ActionEvent actionEvent) {
        try {
        Parent root = FXMLLoader.load(getClass().getResource("/org/example/event_project/Statistique.fxml"));
        Stage stage = new Stage();
