...
public class AccueilController_avis {



    @FXML
    public void goToAvis(ActionEvent event) {
        chargerInterface(event, "/org/example/event_project/avis.fxml");
    }

    @FXML
    public void goToReclamation(ActionEvent event) {
        chargerInterface(event, "/org/example/event_project/reclamation.fxml");
    }
    ...
    public void ouvrirAffichageAvisReclamations() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/event_project/AffichageAvisReclamations.fxml"));
